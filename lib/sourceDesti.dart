...
import 'package:navi/drawPath.dart';
import 'package:navi/masonLoca.dart';
import 'database.dart';
import 'locationFormMultipleSelect.dart';
import 'search_widget.dart';
class SourceDesti extends StatefulWidget {
  final MasonLoca srcLoca;
 
   SourceDesti(this.srcLoca, { Key? key }) : super(key: key);

  @override
  State<SourceDesti> createState() => _SourceDestiState();
}

class _SourceDestiState extends State<SourceDesti> {
            ...
            SafeArea(
              child: Padding(
                ...
                child: Column(
                  children: <Widget>[
                     buildSearch(),
                  Text(tempLoca!=null?"You have selected "+tempLoca!.locaName+" as your destination location":"Please select a destination location from the list below or search for it", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20),textAlign: TextAlign.center,),
                  ...
                  Padding(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:tempLoca!=null? Color.fromARGB(178, 0, 102, 51):Colors.grey,
  ...
  Navigator.push(
    context,
    MaterialPageRoute(builder: (context) =>  DrawPath(widget.srcLoca,tempLoca!)),
  );
                                      }
},
